...
def test_pool_categorization():
    ...
    test_candidates = [
        {"symbol": "US.NVDA", "name": "NVIDIA Corporation", "aeos_score": 0.82, "quote": {"price": 950.0, "change_pct": 12.5, "market_cap": 2.5e12, "turnover": 5e10}},
        {"symbol": "US.SMCI", "name": "Super Micro Computer", "aeos_score": 0.78, "quote": {"price": 850.0, "change_pct": 25.8, "market_cap": 45e9, "turnover": 3e9}},
        {"symbol": "US.AAPL", "name": "Apple Inc.", "aeos_score": 0.65, "quote": {"price": 180.0, "change_pct": 1.2, "market_cap": 3.0e12, "turnover": 8e9}},
        {"symbol": "US.MSFT", "name": "Microsoft Corporation", "aeos_score": 0.72, "quote": {"price": 420.0, "change_pct": 3.5, "market_cap": 3.2e12, "turnover": 6e9}},
        {"symbol": "US.AMD", "name": "Advanced Micro Devices", "aeos_score": 0.68, "quote": {"price": 165.0, "change_pct": 8.2, "market_cap": 270e9, "turnover": 4e9}},
        {"symbol": "US.GOOGL", "name": "Alphabet Inc.", "aeos_score": 0.62, "quote": {"price": 175.0, "change_pct": 2.1, "market_cap": 2.2e12, "turnover": 3e9}},
    ]
...
def main():
    ...
    print("✅ 所有测试完成！")
    print("\n📋 下一步:")
    print("   1. 运行 python3 phase2/ted/run_ted_discovery.py 进行完整发现")
    print("   2. 运行 python3 phase2/ted/run_knot_4dim_research.py --validate-only 做轻量Knot验证")
    print("   3. 查看 /projects/vnpy/state/runs/ted_aggressive_pool_report.json")
    print("   4. 查看 /projects/vnpy/log/ted_discovery.log")
