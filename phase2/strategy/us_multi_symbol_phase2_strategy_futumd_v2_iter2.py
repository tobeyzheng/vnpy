...
class Strategy(StrategyBase):
    ...
    def global_variables(self):
        ...
        self.min_hold_bars = show_variable(15, GlobalType.INT)
        # iter2: absolute disaster guard — forces exit if drawdown from
        # entry exceeds this regardless of min_hold.
        self.disaster_loss_pct = show_variable(0.18, GlobalType.FLOAT)
    ...
    def handle_data(self):
        ...
        for sym in self._pool:
            ...
            if held_qty > 0:
                ...
                if st["entry_price"] > 0 and float(self.disaster_loss_pct) > 0:
