...
class Strategy(StrategyBase):
    ...
    def global_variables(self):
        ...
        # iter4: tighter disaster guard 12% → 10% — single-position
        # downside is capped at -10% before forced exit fires.
        self.disaster_loss_pct = show_variable(0.10, GlobalType.FLOAT)
    ...
    def handle_data(self):
        ...
        for sym in self._pool:
            ...
            # iter4: regime gate now requires Close be above SMA(200)
            # by at least 1 ATR — filters out 'whipsaw' bars that just
            # barely pop the SMA200 only to fall back the next day.
            cond_regime = (ma_regime_val > 0
                           and current_price > ma_regime_val + atr_val)
