...
class Strategy(StrategyBase):
    ...
    def global_variables(self):
        ...
        self.ma_exit = show_variable(150, GlobalType.INT)
        ...
        # iter3: tighter disaster guard (18% → 12%) so 2022-style bear
        # opens don't bleed too long before the absolute cut fires.
        self.disaster_loss_pct = show_variable(0.12, GlobalType.FLOAT)
    ...
    def handle_data(self):
        ...
        for sym in self._pool:
            ...
            if held_qty > 0:
                ...
                if (bool(self.regime_flat_enabled)
                        and ma_regime_val > 0
                        and current_price < ma_regime_val):
                    exit_reason = "regime_flat"
                # iter2 priority 0: absolute disaster cut — always armed,
