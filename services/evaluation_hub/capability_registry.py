    ...
    def _default_items(self) -> list[CapabilityDefinition]:
        return [
            ...
            CapabilityDefinition(
                ...
                outputs=["state/runs/classic_multifactor_intraday_report.json", "state/runs/dry_run/events.jsonl", "state/runs/dry_run/orders/*.json", "state/runs/futu_sim/events.jsonl", "state/runs/futu_sim/orders/*.json", "state/runs/futu_real/events.jsonl", "state/runs/futu_real/orders/*.json"],
            ...
            CapabilityDefinition(
                ...
                outputs=["state/runs/classic_multifactor_daily_report.json", "state/runs/dry_run/events.jsonl", "state/runs/dry_run/orders/*.json", "state/runs/futu_sim/events.jsonl", "state/runs/futu_sim/orders/*.json", "state/runs/futu_real/events.jsonl", "state/runs/futu_real/orders/*.json"],
            ...
            CapabilityDefinition(
                ...
                outputs=["state/runs/us_futu_sim_session_report.json", "state/runs/us_futu_sim_session_state.json", "state/runs/futu_sim/orders/*.json"],
            ...
            CapabilityDefinition(
                ...
                outputs=["state/runs/hk_futu_sim_session_report.json", "state/runs/futu_sim/events.jsonl", "state/runs/futu_sim/orders/*.json"],
                manual_checkpoints=["Requires explicit user confirmation before session execution.", "Must stay in Futu SIMULATE environment only."],
                requires_confirmation=True,
                mutates_state=True,
                connects_remote=True,
            ...
            CapabilityDefinition(
                ...
                outputs=["state/runs/us_live_task_report.json", "state/runs/dry_run/orders/*.json", "state/runs/futu_real/orders/*.json"],
            ...
            CapabilityDefinition(
                ...
                inputs=["candidate inputs", "budget settings", "live-submit flag", "environment switches"],
                outputs=["state/runs/hk_live_task_report.json", "state/runs/dry_run/orders/*.json", "state/runs/futu_real/orders/*.json"],
                manual_checkpoints=["Real execution must be explicitly approved.", "Confirm VNPY_LIVE_CONFIG/VNPY_LIVE_SUBMIT/VNPY_LIVE_APPROVED before any non-dry-run path."],
                requires_confirmation=True,
                mutates_state=True,
                connects_remote=True,
