...
call. Output is mirrored to ``state/runs/holdings_knot_review.json``.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", default="state/runs/holdings_knot_review.json",
